...
WinJS.Namespace.define("Elipce.Bdd", {
    ...
    dev: false // TODO mettre à false en production
});
...
WinJS.Namespace.define("Elipce.Ws", {
    racine: (Elipce.Bdd.dev ? "http://192.168.1.26/bibliodoc-web/ws/index.php/" : "http://85.14.137.12/elipce/bibliodoc-web/ws/index.php/")
});

WinJS.Namespace.define("Elipce.Document", {

    bibliodoc: (Elipce.Bdd.dev ? "http://192.168.1.26/projects/bibliodoc-web/application/" : "http://85.14.137.12/elipce/bibliodoc-web/application/")
});
